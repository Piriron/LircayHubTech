...
<div id="libraries">
    ...
    <div class="daterangepicker ltr show-ranges opensright">
      <div class="ranges">
        <ul>
          <li data-range-key="Hoy">Hoy</li>
          <li data-range-key="Ayer">Ayer</li>
          <li data-range-key="Ultimos 7 dias">Ultimos 7 dias</li>
          <li data-range-key="Ultimos 30 dias">Ultimos 30 dias</li>
          <li data-range-key="Este Mes">Este Mes</li>
          <li data-range-key="Ultimo Mes">Ultimo Mes</li>
          <li data-range-key="Rango Personalizado">Rango Personalizado</li>
        </ul>
      </div>

        ...
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            <?php if($_settings->userdata('id') > 0): ?>
              ...
              <span class="mx-2">Hola, <?= !empty($_settings->userdata('username')) ? $_settings->userdata('username') : $_settings->userdata('email') ?></span>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=check_status" class="nav-link <?= isset($page) && $page =='check_status' ? "active" : "" ?>">Comprobar Estado</a>
              </li>
              <li class="nav-item">
                <a href="./?page=services" class="nav-link <?= isset($page) && $page =='services' ? "active" : "" ?>">Equipos</a>
              </li>
              <li class="nav-item">
                <a href="./?page=about" class="nav-link <?= isset($page) && $page =='about' ? "active" : "" ?>">Sobre Nosotros</a>
              </li>
              <li class="nav-item">
                <a href="./?page=contact_us" class="nav-link <?= isset($page) && $page =='contact_us' ? "active" : "" ?>">Contacta con Nosotros</a>
              </li>

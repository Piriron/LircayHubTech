...
<div class="container-fluid">
    <form action="" id="service-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="service" id="service" class="form-control form-control-border" placeholder="Servicio" value ="<?php echo isset($service) ? $service : '' ?>" required>
        </div>
        <div class="form-group">
            <label for="description" class="control-label">Descripcion</label>
            <textarea rows="3" name="description" id="description" class="form-control form-control-sm rounded-0" placeholder="Escriba aquí la descripción del servicio." required><?php echo isset($description) ? $description : '' ?></textarea>
        </div>
        <div class="form-group">

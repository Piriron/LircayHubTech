                        ...
                        <fieldset>
                            <div class="row">
                                <div class="form-group col-md-8">
                                   <select name="client_id" id="client_id" class="form-control form-control-sm form-control-border select2" data-placeholder="Seleccione el cliente aquí">
                                       <option value="" disabled <?= !isset($client_id) ? "Seleccionar" : "" ?>></option>
                                       <?php 
                                       ...
                                       while($row = $clients->fetch_assoc()):
                                        if($row['delete_flag'] == 1 && (!isset($client_id) || (isset($client_id) && $client_id != $row['id'])))
                                            continue;
                                       ?>
                                       <option value="<?= $row['id'] ?>" <?= isset($client_id) && $client_id == $row['id'] ? "Seleccionar" : "" ?>><?= $row['name'] ?></option>
                                       <?php endwhile; ?>
                                   </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend class="text-muted border-bottom">Marcas</legend>
                                        <div class="row">
                                            <div class="form-group col-md-9">
                                                <select  id="service" class="form-control form-control-sm form-control-border select2" data-placeholder="Seleccione la marca aquí">
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend class="text-muted border-bottom">Tipo de Equipo</legend>
                                        <div class="row">
                                            <div class="form-group col-md-9">
                                            <select  id="service" class="form-control form-control-sm form-control-border select2" data-placeholder="Seleccione el tipo de Equipo">
                                                ...
                                                <small class="text-muted px-4">SELECCIONE AQUI EL TIPO DEL EQUIPO DE LA LISTA DE ARRIBA</small>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="number" step="any" id="mcost" class="form-control form-control-sm form-control-border text-right" value="0.00">
                                                <small class="text-muted px-4">Costo</small>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <button class="btn btn-flat btn-primary btn-sm" type="button" id="add_material"><i class="fa fa-plus"></i> Agregar a la lista</button>
                                            </div>
                                        </div>
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="material_list">
                                            ...
                                            <thead>
                                                <tr class='bg-gradient-dark text-light'>
                                                    <th class="text-center py-1"></th>
                                                    <th class="text-center py-1">Nombre material</th>
                            ...
                            <div class="row mt-3">
                                <div class="form-group col-md-12">
                                    ...
                                    <h3><b>Total a Pagar: <span id="total_amount" class="pl-3">0.00</span></b></h3>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-8 col-lg-7">
                                <small class="text-muted px-4">Observaciones</small>
                                    <textarea  name="remarks" id="remarks" rows="3" class="form-control form-control-sm rounded-0"><?= isset($remarks) ? $remarks : "" ?></textarea><input type="date" value="2022-07-25"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <select name="payment_status" id="payment_status" class="form-control form-control-sm form-control-border" required>
                                        <option value="0" <?= isset($payment_status) && $payment_status == 0 ? "selected" : "" ?>>No pagado</option>
                                        <option value="1" <?= isset($payment_status) && $payment_status == 1 ? "selected" : "" ?>>Pagado</option>
                                    </select>
                                    <small class="text-muted px-4">Estado de Pago</small>
                                </div>
                                <div class="form-group col-md-4">
                                    <select name="status" id="status" class="form-control form-control-sm form-control-border" required>
                                        ...
                                        <option value="3" <?= isset($status) && $status == 3 ? "selected" : "" ?>>Comprobación</option>
                                        <option value="4" <?= isset($status) && $status == 4 ? "selected" : "" ?>>Hecho</option>
                                        <option value="5" <?= isset($status) && $status == 5 ? "selected" : "" ?>>Cancelar</option>
                                    </select>
...
<script>
    ...
    $(function(){
        ...
        $('.select2').each(function(){
            var _this = $(this)
            _this.select2({
                placeholder:_this.attr('data-placeholder') || 'Seleccione aquí',
                width:'100%'
            })
        })

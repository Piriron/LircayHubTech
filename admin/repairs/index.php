<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=repairs/manage_repair" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Añadir entrada</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Estás seguro de eliminar esta reparación de forma permanente?","delete_repair",[$(this).attr('data-id')])
		})

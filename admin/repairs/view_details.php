        ...
        <div class="card-body">
            <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-bordered border-info">
                                    ...
                                    <tr>
                                        <th class="text-muted text-white bg-gradient-dark px-2 py-1">Codigo</th>
                                        <td><?= ($code) ?></td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="row">
                                        ...
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="service_list">
                                            ...
                                            <thead>
                                                <tr class='bg-gradient-dark text-light'>
                                                    <th class="text-center py-1">Marca</th>
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="material_list">
                                            ...
                                            <thead>
                                                <tr class='bg-gradient-dark text-light'>
                                                    <th class="text-center py-1">Tipo de Equipo</th>
                            ...
                            <div class="row mt-3">
                                <div class="form-group col-md-12">
                                    <h3><b>Total a Pagar: <span id="total_amount" class="pl-3"><?=number_format($total_amount,2)?></span></b></h3>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-4">
									...
									switch ($status){
										...
										case 2:
											...
											break;
										case 3:
											echo '<span class="ml-4 rounded-pill badge badge-warning">Comprobando</span>';
											break;
										case 4:
											echo '<span class="ml-4 rounded-pill badge badge-success">Hecho</span>';
											break;
										case 5:
                ...
                <div class="rounded-0 text-center mt-3">
                        ...
                        <button class="btn btn-sm btn-danger btn-flat" type="button" id="delete_data"><i class="fa fa-trash"></i> Borrar</button>
                        <a class="btn btn-light border btn-flat btn-sm" href="./?page=repairs" ><i class="fa fa-angle-left"></i> Volver a la lista</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(function(){
        $('#delete_data').click(function(){
			_conf("¿Estás seguro de eliminar <b><?= $code ?>\'s</b> de la reparación de forma permanente?","delete_repair",['<?= $id ?>'])
		})
    })

...
<h1>Bienvenido a <?php echo $_settings->info('name') ?> - Panel Admin</h1>
...
<div class="row">
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Comprobación de reparaciones</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Reparaciones hechas</span>
            <span class="info-box-number text-right">
                <?php 

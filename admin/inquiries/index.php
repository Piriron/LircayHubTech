					...
					?>
						<tr>
							...
							<td class="text-center">
								...
								<?php else: ?>
								<span class="badge badge-pill badge-primary">No leído</span>
								<?php endif; ?>
							</td>
							<td align="center">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Estas seguro de eliminar esta consulta de forma permanente?","delete_message",[$(this).attr('data-id')])
		})
		$('.table td,.table th').addClass('py-1 px-2 align-middle')
		$('.view_details').click(function(){
			uni_modal('Detalles de la Consulta',"inquiries/view_details.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.table').dataTable();

            ...
            <div class="card rounded-0 card-outline card-navy shadow" >
                <div class="card-body rounded-0">
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="fullname" name="fullname" required placeholder="Gonzalo Burgos">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="px-3 text-muted">Nº Contacto</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="message" id="message" rows="4" class="form-control form-control-sm rounded-0" required placeholder="Escriba su mensaje aquí"></textarea>
                            </div>
                        </div>
                        <div class="row">

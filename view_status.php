...
if(isset($_GET['code'])){
    ...
    echo "<script>alert('Se requiere código del equipo'); location.replace('./');</script>";
}
?>
<style>
    @media screen {
...
<div class="content py-3">
    <div class="card card-outline card-dark rounded-0">
        <div class="card-header rounded-0">
            <h5 class="card-title text-primary">Detalles de los equipos</h5>
        </div>
        <div class="card-body">
            <div class="container-fluid">
                <div id="outprint">
                    <fieldset>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend class="text-muted border-bottom">Equipos</legend>
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="service_list">
                                            ...
                                            <thead>
                                                <tr class='bg-gradient-dark text-light'>
                                                    <th class="text-center py-1">Equipo</th>
                                ...
                                <div class="form-group col-md-4">
									...
									switch ($status){
										...
										case 1:
											...
											break;
										case 2:
											echo '<span class="ml-4 rounded-pill badge badge-info">In-Progreso</span>';
											break;
										case 3:
                ...
                <div class="rounded-0 text-center mt-3">
                        <a class="btn btn-light border btn-flat btn-sm" href="./?page=check_status" ><i class="fa fa-angle-left"></i> Volver</a>
                </div>
            </div>
        </div>
    </div>
